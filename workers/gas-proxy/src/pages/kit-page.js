  ...
  container.innerHTML =
    '<div class="kit-sticky">' +
      ...
      '<div class="guide-banner">' +
        '<strong>使い方:</strong> 商品をタップで展開 → 「画像をまとめて保存」で撮影画像をダウンロード → 「コピー」でタイトル・説明文をコピー → メルカリに貼り付け → 「出品したらチェック」で次へ！' +
        '<details><summary>出品手順を見る</summary>' +
          '<div class="guide-steps">' +
            '<span>1</span> 「メルカリで出品」から出品ページを開く<br>' +
            '<span>2</span> 各商品の「画像をまとめて保存」（PCは「ZIP」）で撮影画像をダウンロード → メルカリにアップロード<br>' +
