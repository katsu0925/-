  ...
  window.startListingBrowser = function(index) {
    ...
    navigator.clipboard.writeText(data).then(function() {
      ...
      bannerMsg.innerHTML = '<div style="margin:8px 0">' +
        ...
        'javascript:void(navigator.clipboard.readText().then(function(s){try{var d=JSON.parse(s);var els=document.querySelectorAll(&quot;input[type=text],input:not([type]),textarea&quot;);var tD=false,dD=false;for(var i=0;i&lt;els.length;i++){var el=els[i];var p=(el.getAttribute(&quot;placeholder&quot;)||&quot;&quot;);if(!tD&amp;&amp;el.tagName===&quot;INPUT&quot;&amp;&amp;p.indexOf(&quot;300&quot;)===-1&amp;&amp;d.t){var nv=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,&quot;value&quot;).set;nv.call(el,d.t);el.dispatchEvent(new Event(&quot;input&quot;,{bubbles:true}));el.dispatchEvent(new Event(&quot;change&quot;,{bubbles:true}));tD=true}if(!dD&amp;&amp;el.tagName===&quot;TEXTAREA&quot;&amp;&amp;d.d){var nv2=Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype,&quot;value&quot;).set;nv2.call(el,d.d);el.dispatchEvent(new Event(&quot;input&quot;,{bubbles:true}));el.dispatchEvent(new Event(&quot;change&quot;,{bubbles:true}));dD=true}};alert(tD&amp;&amp;dD?&quot;\\u2705 自動入力完了！商品名と説明文を入力しました&quot;:&quot;\\u26A0 一部入力できませんでした&quot;)}catch(e){alert(&quot;\\u274C データ読取失敗: デキルンで出品するボタンを先にタップしてください&quot;)}}))' +
        '</div></div></details>';
      var ref = [];
