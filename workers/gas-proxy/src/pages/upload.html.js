      ...
      <div class="manage-sticky-header">
        ...
        <div id="filterBar" style="display:none;margin-bottom:6px;font-size:12px">
          ...
          <div style="display:flex;gap:4px;align-items:center">
            <label style="flex:1;position:relative"><span style="position:absolute;left:8px;top:5px;font-size:11px;color:#999;pointer-events:none" id="filterDateFromLabel">開始日</span><input type="date" id="filterDateFrom" onchange="filterManageList();this.previousElementSibling.style.display=this.value?'none':''" style="width:100%;padding:4px 6px;border:1px solid #ddd;border-radius:6px;font-size:12px;background:#fff"></label>
            <span style="font-size:11px;color:#999;flex-shrink:0">〜</span>
            <label style="flex:1;position:relative"><span style="position:absolute;left:8px;top:5px;font-size:11px;color:#999;pointer-events:none" id="filterDateToLabel">終了日</span><input type="date" id="filterDateTo" onchange="filterManageList();this.previousElementSibling.style.display=this.value?'none':''" style="width:100%;padding:4px 6px;border:1px solid #ddd;border-radius:6px;font-size:12px;background:#fff"></label>
