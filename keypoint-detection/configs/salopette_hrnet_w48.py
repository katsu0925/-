...
model = dict(
    ...
    head=dict(
        type='HeatmapHead',
        in_channels=48,
        out_channels=10,  # salopette: 10キーポイント
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode='topdown',
        ann_file='annotations/dummy_salopette_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode='topdown',
        ann_file='annotations/dummy_salopette_val.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/dummy_salopette_val.json',
    use_area=True,
