...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode='topdown',
        ann_file='annotations/dummy_tops_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode='topdown',
        ann_file='annotations/dummy_tops_val.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/dummy_tops_val.json',
    use_area=True,
