...
var REQUEST_SHEET_COLS = {
  ...
  SHIP_SIZE: 22, BOX_COUNT: 23,
  STATUS: 24, STAFF: 25, LIST_ENCLOSED: 26, XLSX_SENT: 27,
  INVOICE_REQ: 28, INVOICE_SENT: 29, NOTIFY_FLAG: 30, SHIP_NOTIFY_FLAG: 31,
  NOTE: 32, REWARD: 33, UPDATED_AT: 34, CHANNEL: 35,
  TRACKING_URL: 36, ITEM_PRICES: 37, KIT_URL: 38, CP_ISSUED_AT: 39
};
