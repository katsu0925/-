...
function chatbot_buildSystemPrompt_() {
  ...
  return [
    ...
    '・商品合計¥30,000以上で送料無料（※初回50%OFF適用時・沖縄/離島・アソートの価格破壊商品は対象外）',
    '',
    '【発送について】',
    ...
    '・沖縄：2,500〜3,500円',
    '・離島は配送対象外の場合があります',
    '・ダイヤモンド会員は送料無料（沖縄・離島含む）',
    '・商品合計¥30,000以上で送料無料（※初回50%OFF適用時・沖縄/離島・アソートの価格破壊商品は対象外で送料別途）',
    '',
    '【新商品の入荷について】',
    ...
    '・シルバー（年間5万円以上）：ポイント3%',
    '・ゴールド（年間20万円以上）：ポイント5%',
    '・ダイヤモンド（年間50万円以上）：ポイント5% + 送料無料（沖縄・離島含む）',
...
function chatbot_fallbackReply_(message) {
  ...
  var rules = [
    ...
    [['送料', '配送', '発送'],
     ...
     '※離島は配送対象外の場合があります。\n\n' +
     '【送料無料の条件】\n' +
     '・ダイヤモンド会員（年間50万円以上購入）※沖縄・離島も対象\n' +
     '・商品合計¥30,000以上\n' +
     '※初回50%OFF適用時・沖縄/離島・アソートの「価格破壊商品」は¥30,000以上でも対象外です（商品カードに「送料別途」と表示されます）。\n\n' +
     '入金確認後、3〜5営業日（土日祝休み）以内に発送いたします。'],
    ...
    [['注文', '購入', '買い方', '買う', '頼み方', 'カート', '手順', '流れ', 'やり方', '使い方'],
     ...
     '4. 決済方法を選んで注文確定\n\n' +
     '※最低注文数は5点からです（アソート商品と同時購入なら1点からOK）。在庫は先着順のためお早めにどうぞ。'],
    ...
    [['割引', 'セール', '安く', 'お得', 'クーポン', 'キャンペーン', 'オフ', 'off', 'OFF', '値引'],
     ...
     '・初回50%OFFキャンペーン（会員登録後の初回注文、2026年9月末まで）\n' +
     '・商品合計¥30,000以上で送料無料！\n' +
     '　※初回50%OFFキャンペーン適用時・沖縄/離島・アソートの「価格破壊商品」は¥30,000以上送料無料の対象外です\n\n' +
    ...
    [['会員', 'ランク', 'ポイント', '登録', 'アカウント', 'ログイン', 'サインアップ'],
     ...
     '・シルバー（年間5万円〜）：ポイント3%\n' +
     '・ゴールド（年間20万円〜）：ポイント5%\n' +
     '・ダイヤモンド（年間50万円〜）：ポイント5% + 送料無料（沖縄・離島含む）\n\n' +
     '【救済復活】\n' +
    ...
    // --- 最低注文数 ---
    [['最低', '何点', '何枚', '1点', '1枚', '少量'],
     'デタウリの最低注文数は5点からです（アソートと同時注文時は1点からOK）。\n' +
     '会員登録で全品10%OFF、商品合計¥30,000以上で送料無料になります（沖縄・離島は送料無料対象外）。'],
