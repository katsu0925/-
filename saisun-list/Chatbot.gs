...
function chatbot_buildSystemPrompt_() {
  ...
  return [
    ...
    '・商品合計¥30,000以上で送料無料（※初回50%OFF適用時・沖縄県・アソートの価格破壊商品は対象外）',
    '',
    '【発送について】',
    ...
    '・離島は配送対象外の場合があります',
    '・ダイヤモンド会員は送料無料（沖縄県含む）',
    '・商品合計¥30,000以上で送料無料（※初回50%OFF適用時・沖縄県・アソートの価格破壊商品は対象外で送料別途）',
    '',
    '【新商品の入荷について】',
...
function chatbot_fallbackReply_(message) {
  ...
  var rules = [
    ...
    [['送料', '配送', '発送'],
     ...
     '・商品合計¥30,000以上\n' +
     '※初回50%OFF適用時・沖縄県・アソートの「価格破壊商品」は¥30,000以上でも対象外です（商品カードに「送料別途」と表示されます）。\n\n' +
     '入金確認後、3〜5営業日（土日祝休み）以内に発送いたします。'],
    ...
    [['割引', 'セール', '安く', 'お得', 'クーポン', 'キャンペーン', 'オフ', 'off', 'OFF', '値引'],
     ...
     '・初回50%OFFキャンペーン（会員登録後の初回注文、2026年9月末まで）\n' +
     '・商品合計¥30,000以上で送料無料！\n' +
     '　※初回50%OFFキャンペーン適用時・沖縄県・アソートの「価格破壊商品」は¥30,000以上送料無料の対象外です\n\n' +
    ...
    [['最低', '何点', '何枚', '1点', '1枚', '少量'],
     ...
     '会員登録で全品10%OFF、商品合計¥30,000以上で送料無料になります（沖縄県は送料無料対象外）。'],
