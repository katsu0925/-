...
function chatbot_buildSystemPrompt_() {
  ...
  return [
    ...
    '・100点以上ご購入で20%割引',
    '・' + memberDiscountText,
    '・商品合計1万円以上で送料無料（※初回50%OFF適用時・アソートの価格破壊商品は対象外）',
    '',
    '【発送について】',
    ...
    '・離島は配送対象外の場合があります',
    '・ダイヤモンド会員は送料無料',
    '・商品合計1万円以上で送料無料（※初回50%OFF適用時・アソートの価格破壊商品は対象外で送料別途）',
    '',
    '【新商品の入荷について】',
...
function chatbot_fallbackReply_(message) {
  ...
  var rules = [
    ...
    [['送料', '配送', '発送'],
     ...
     '・ダイヤモンド会員（年間50万円以上購入）\n' +
     '・商品合計1万円以上\n' +
     '※初回50%OFF適用時・アソートの「価格破壊商品」は1万円以上でも対象外です（商品カードに「送料別途」と表示されます）。\n\n' +
     '入金確認後、3〜5営業日（土日祝休み）以内に発送いたします。'],
    ...
    [['割引', 'セール', '安く', 'お得', 'クーポン', 'キャンペーン', 'オフ', 'off', 'OFF', '値引'],
     ...
     '・10点以上で5%OFF / 30点10%OFF / 50点15%OFF / 100点20%OFF\n' +
     '・会員登録で10%OFF（2026年9月末まで）\n' +
     '・商品合計1万円以上で送料無料！\n' +
     '　※初回50%OFFキャンペーン適用時・アソートの「価格破壊商品」は1万円以上送料無料の対象外です\n\n' +
    ...
    [['最低', '何点', '何枚', '1点', '1枚', '少量'],
     ...
     '10点以上で5%OFF、30点以上で10%OFF、50点以上で15%OFF、100点以上で20%OFFとまとめ買いがお得です。'],
