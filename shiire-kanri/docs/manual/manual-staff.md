...
**結論: 圏外でもアプリの操作はすべて受け付けられます。** 採寸保存・写真アップ・経費申請・移動登録など、どんな操作も「成功しました」と表示されたらアプリ側で **責任を持って保存** し、通信が復帰したら自動で送信されます。
...
- ブラウザを更新して再試行
- **圏外でも画像は保存されます**: 右下に「⏳ 未送信」バッジが出ていれば、復帰時に自動アップロードされます
