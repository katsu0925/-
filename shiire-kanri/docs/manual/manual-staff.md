...
入力項目：撮影日付・撮影者・出品日・出品者・使用アカウント・リンク（出品ページの URL）

:::note
**商品写真そのものは、この管理アプリでは登録しません。** 写真の登録は **内部タスキ箱**（別の専用ツール）で行い、写真は 1 商品あたり **10 枚まで** です。このタブで入力するのは、撮影・出品の「日付・担当者・アカウント・リンク」などの記録です。
:::
...
:::note
発送済み商品への **完了日** のつけ方は、後述の「発送管理タブ」を参照してください。
:::
